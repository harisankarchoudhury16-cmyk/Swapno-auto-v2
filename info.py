...
# Bot information
SESSION = environ.get('SESSION', 'GMFileProviderBot')
...
reqst_channel = environ.get('REQST_CHANNEL', '-1003444288916')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002524198335')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://teligramwalebhaiya_db_user:bohaSAeafY8E2yEQ@cluster0.wlngqsd.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Gm_Support_chat') # Support Chat Link Without https:// or @
